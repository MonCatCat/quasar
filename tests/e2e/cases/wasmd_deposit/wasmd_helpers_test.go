...
func (s *WasmdLPDeposit) deployPrimitives(ctx context.Context, acc *ibc.Wallet, filePath, label string, initArgs1, initArgs2, initArgs3 any) {
...
func (s *WasmdLPDeposit) deployRewardsContract(ctx context.Context, acc *ibc.Wallet, filePath string) {
	// Read the contract from os file
	contract, err := os.ReadFile(filePath)
	s.Require().NoError(err)
...
func (s *WasmdLPDeposit) deployVault(ctx context.Context, acc *ibc.Wallet, filePath, label string, initArgs any) string {
	accAddress := acc.Bech32Address(s.Quasar().Config().Bech32Prefix)
...
func (s *WasmdLPDeposit) setDepositorForContracts(ctx context.Context, acc *ibc.Wallet, initArgs any) {
...
func (s *WasmdLPDeposit) CreatePools(ctx context.Context) {
